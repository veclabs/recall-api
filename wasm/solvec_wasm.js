/* @ts-self-types="./solvec_wasm.d.ts" */
...
class WasmHNSWIndex {
    ...
    collectionStats() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmhnswindex_collectionStats(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    contains(id) {
        ...
        const ret = wasm.wasmhnswindex_contains(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
     ...
     */
    static defaultCosine() {
        const ret = wasm.wasmhnswindex_defaultCosine();
    ...
    delete(id) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmhnswindex_delete(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
    ...
    static fromJson(json) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmhnswindex_fromJson(ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WasmHNSWIndex.__wrap(ret[0]);
    }
    /**
    ...
    getMemory(id) {
        ...
        try {
            const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmhnswindex_getMemory(this.__wbg_ptr, ptr0, len0);
            deferred2_0 = ret[0];
            deferred2_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    insert(id, values, metadata_json) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        ...
        const ret = wasm.wasmhnswindex_insert(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    inspect(query_json) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmhnswindex_inspect(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    merkleHistory() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmhnswindex_merkleHistory(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     * @param {number} metric
     */
    constructor(m, ef_construction, metric) {
        const ret = wasm.wasmhnswindex_new(m, ef_construction, metric);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
    ...
    query(values, top_k) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmhnswindex_query(this.__wbg_ptr, ptr0, len0, top_k);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     * @returns {boolean}
     */
    restoreVector(id, values) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArrayF32ToWasm0(values, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.wasmhnswindex_restoreVector(this.__wbg_ptr, ptr0, len0, ptr1, len1);
        return ret !== 0;
    }
    /**
     ...
     * @returns {string}
     */
    searchWithRecords(values, top_k) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passArrayF32ToWasm0(values, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.wasmhnswindex_searchWithRecords(this.__wbg_ptr, ptr0, len0, top_k);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
     ...
     */
    setEfSearch(ef) {
        wasm.wasmhnswindex_setEfSearch(this.__wbg_ptr, ef);
    }
    /**
    ...
    stats() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.wasmhnswindex_stats(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    tamperVector(id) {
        const ptr0 = passStringToWasm0(id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wasmhnswindex_tamperVector(this.__wbg_ptr, ptr0, len0);
        return ret !== 0;
    }
    /**
    ...
    toJson() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.wasmhnswindex_toJson(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
...
exports.WasmHNSWIndex = WasmHNSWIndex;
 ...
 * @returns {boolean}
 */
function verifyMerkleProof(proof_json, expected_root_hex) {
    const ptr0 = passStringToWasm0(proof_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(expected_root_hex, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.verifyMerkleProof(ptr0, len0, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0] !== 0;
...
const wasmPath = `${__dirname}/solvec_wasm_bg.wasm`;
